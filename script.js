            ...
            if (newQuestText.value !== "") {
                ...
                if (optionsArr.length > 1) {
                    ...
                    if (isChecked) {
                        ...
                        alert('You missed checking the correct answer or you checked an answer without a value');
                        return false;
                    }
                } else {
...
var UIController = (function () {
    ...
    var domItems = {
        ...
        finaScoreText: document.getElementById("final-score-text")
    };
    ...
    return {
        ...
        clearQuestList: function (storageQuestList) {
            ...
            if (storageQuestList.getQuestionCollection().length > 0) {
                ...
                if (storageQuestList.getQuestionCollection !== null) {
                    ...
                    var conf = confirm('Warning! You will delete the entire question list.');
        ...
        newDesign: function (ansResult, selectedAnswer) {
            ...
            twoOptions = {
                ...
                optionsSpanBg: ['rgba(200, 0, 0, 0.7)', 'rgba(107, 254, 1, 0.7)']
            };
            ...
            if (domItems.firstNameInput.value !== "" && domItems.lastNameInput.value !== "") {
                ...
                if (!(domItems.firstNameInput.value === admin[0] && domItems.lastNameInput.value === admin[1])) {
                    ...
                    if (storageQuestList.getQuestionCollection().length > 0) {
                        ...
                        alert('The quiz is NOT ready. Please contact the administator');
                    }
        ...
        finalResult: function (currPerson, storageQuestList) {


            domItems.finaScoreText.textContent = currPerson.fullname[0] + ' ' + currPerson.fullname[1] + ', your final score is ' + currPerson.score + ' out of ' + domItems.progressBar.max;
        ...
        addResultsOnPanel: function (userData) {
            ...
            for (var i = 0; i < userData.getPersonData().length; i++) {
                ...
                resultHTML = '<p class="person person-' + i + '"><span class="person-' + i + '">' + userData.getPersonData()[i].firstname + ' ' + userData.getPersonData()[i].lastname + ' - ' + userData.getPersonData()[i].score + ' out of ' + domItems.progressBar.max + '</span><button id="delete-result-btn_' + userData.getPersonData()[i].id + '" class="delete-result-btn">Delete</button></p> ';
        ...
        clearResultList: function (userData) {
            ...
            if (userData.getPersonData() !== null) {
                ...
                if (userData.getPersonData().length > 0) {
                    ...
                    conf = confirm('Warning! You will lose the entire result list.');
...
var controller = (function (quizCtrl, UICtrl) {
    ...
    UICtrl.addResultsOnPanel(quizCtrl.getPersonLocalStorage);
